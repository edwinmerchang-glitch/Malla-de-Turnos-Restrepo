...
if st.session_state.menu_open:
    with st.container():
        ...
        st.markdown('</div>', unsafe_allow_html=True)  # Cerrar side-menu

# -------- CONTENIDO --------
op = st.session_state.pagina_actual

# ... (aquí continúa todo el resto de tu código con las páginas)
